...
| `screens/document-center.html` | Real — Documents to Sign + Leases & Documents registers, from file `Sip0wuWPnMa5duL1L39HDn`, node `2786:46043`. See "Document Center" below. Replaces the old `lease-account.html` placeholder (deleted — its remaining unbuilt scope was "Messages", not Documents; Account is already covered by `account.html`). |
